...
import type { RegionForecast, DayForecast, SourceStatus, WeatherResponse } from "./types"
...
export async function fetchAllWeather(): Promise<WeatherResponse> {
  ...
  return {
    ...
    sources: { openmeteo: omStatus, tomorrow: tmStatus, weatherapi: waStatus },
    fetchedAt,
    nextRefreshAt,
  }
}
